...
public class  wk7_lab1 {
	...
	//	System.out.println(computerNum);
		...
		{	
			JOptionPane.showMessageDialog(null,"Yaay you win! You won "+ userWins +" times, and the computer won " + compWins + " times! and there were " + ties + " ties");
			turns = false;
		}
		
		if (compWins > halfgames)
		{
			JOptionPane.showMessageDialog(null,"You lost! You won "+ userWins +" times, and the computer won " + compWins + " times! and there were " + ties + " ties");
			turns = false;
		}
	}
